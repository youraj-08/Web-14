...
import HarmonicaIcon from './Aurora';
...
function Copyright() {
  return (
    <Typography variant="body2" sx={{ color: 'text.secondary', mt: 1 }}>
      {'Copyright © '}
      <Link color="text.secondary" href="https://www.instagram.com/youraj_08/">
        Harmonica
      </Link>
      &nbsp;
      ...
      >
        ...
        >
          <IconButton
            color="inherit"
            size="small"
            href="https://github.com/youraj-08"
            aria-label="GitHub"
            sx={{ alignSelf: 'center' }}
          >
            <GithubIcon />
          ...
          <IconButton
            color="inherit"
            size="small"
            href="https://www.facebook.com/share/1ZKk38wGQ8/?mibextid=wwXIfr"
            aria-label="X"
            sx={{ alignSelf: 'center' }}
          >
            <FacebookIcon />
          ...
          <IconButton
            color="inherit"
            size="small"
            href="www.linkedin.com/in/youraj08"
            aria-label="LinkedIn"
            sx={{ alignSelf: 'center' }}
          >
            <LinkedInIcon />
